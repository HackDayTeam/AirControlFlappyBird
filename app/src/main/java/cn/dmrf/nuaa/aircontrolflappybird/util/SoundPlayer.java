package cn.dmrf.nuaa.aircontrolflappybird.util;
...
public class SoundPlayer {
	...
	public void initSounds() {
		...
		map.put(2, soundPool.load(mainActivity, R.raw.pass, 1));
		map.put(3, soundPool.load(mainActivity, R.raw.hit, 1));
		map.put(4, soundPool.load(mainActivity, R.raw.die, 1));
		map.put(5, soundPool.load(mainActivity, R.raw.swooshing, 1));
	}
